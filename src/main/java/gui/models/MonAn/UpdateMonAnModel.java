...
public class UpdateMonAnModel {
    ...
    public UpdateMonAnModel(int id, String ten, String hinhAnh, int idLoaiMonAn, int gia, int giaKhuyenMai, int idTtinhTrangMonAn, String noiDung) {
        this.id = id;
        this.ten = ten;
