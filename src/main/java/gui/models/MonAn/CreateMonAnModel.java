...
public class CreateMonAnModel {
    ...
    public CreateMonAnModel(String ten, String hinhAnh, int idLoaiMonAn, int gia, int giaKhuyenMai, int idTtinhTrangMonAn, String noiDung) {
        this.ten = ten;
